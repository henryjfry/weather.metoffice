...
try:
	...
	from metoffice.constants import WINDOW, ADDON, API_KEY, CURRENT_VIEW, ADDON_DATA_PATH, ADDON_BANNER_PATH, WEATHER_WINDOW_ID, ADDON_BROWSER_WINDOW_ID, DIALOG, WINDOW, TEMPERATUREUNITS, ADDON
...
def failgracefully(f):
    ...
    def wrapper(*args, **kwds):
        try:
            ...
            log(traceback.format_exc(), xbmc.LOGFATAL)
...
def gettext(s):
    ...
    try:
        ...
        log('String "{0}" not translated.'.format(s), level=xbmc.LOGFATAL)
        return s
